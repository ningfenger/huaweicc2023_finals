...
class Controller:
    ...
    def select_target_before_radar(self, idx_robot):
        # 雷达前的版本
        robot = self.robots[idx_robot]
        robot_loc_m = np.array(robot.loc).copy()
        path_loc_m = robot.path.copy()
    ...
    def move_before_radar(self, idx_robot):
    # 360雷达前的版本
        robot = self.robots[idx_robot]
        k_r = 8
